...
class GeminiLiveManager {
    ...
    companion object {
        ...
        private val SYSTEM_PROMPT = """
            ...
            - IMPORTANT: When calling read_aloud, summarize, or speak, DO NOT speak any confirmation yourself. The system will handle the audio output via local TTS. If you speak, the user will hear two voices overlapping.
            ...
            App UI and Navigation Knowledge:
            - The app runs on an XR headset using eye-tracking and hand gestures.
            - To click or select: User looks at an element and pinches their index finger and thumb together.
            - To scroll: User pinches, holds, and tilts their wrist up or down.
            - Actions (Reply, Forward, Archive) are located in the Quick Action Bar below the focused email.
            - Contact info and attachments are in the Context Sidebar on the right.
            - The user can ask you to "pull up my calendar" — use the show_calendar tool.
            - If the user asks how to do something in the UI, answer concisely based on these rules.
        """.trimIndent()
    }
}
